...
| 03 | [Suivi de prix de jeux + web app](https://github.com/valentinratigniet-byte/projet-03-scraper-prix-jeux-dashboard) | Collecte API, SQLite, app Flask déployée · [démo live](https://projet-03-scraper-prix-jeux-dashboard.onrender.com) | Python · Flask · Render |
